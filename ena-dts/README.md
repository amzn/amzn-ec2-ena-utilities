...
```
+---------------+------+-------+------------------------+------+-----------------+----------------+
| direction     | size | flows | Tx queues DUT / Tester | type | Rx on DUT, Mb/s | Rx on DUT, pps |
+===============+======+=======+========================+======+=================+================+
| Tester -> DUT | 64   | 1     | 0 / 1                  | tcp  | 544             | 809802         |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 64   | 1     | 0 / 1                  | udp  | 922             | 1372808        |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 64   | 8     | 0 / 8                  | tcp  | 668             | 995290         |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 64   | 8     | 0 / 8                  | udp  | 1155            | 1718936        |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 9000 | 1     | 0 / 1                  | tcp  | 3341            | 46311          |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 9000 | 1     | 0 / 1                  | udp  | 3332            | 46178          |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 9000 | 8     | 0 / 8                  | tcp  | 25775           | 357194         |
+---------------+------+-------+------------------------+------+-----------------+----------------+
| Tester -> DUT | 9000 | 8     | 0 / 8                  | udp  | 25792           | 357432         |
+---------------+------+-------+------------------------+------+-----------------+----------------+
```
